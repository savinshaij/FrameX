...
const Footer = () => {
    return (
        <>
            <footer className=" flex  justify-center items-center dark:bg-[rgb(17,19,38)]  w-full  pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
                    ...
                    <div className="mx-4 flex flex-wrap">
                        <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                            <div className="mb-10 w-full">
                                ...
                                <p className="mb-7 text-base text-body-color dark:text-gray-500">
                        ...
                        <LinkGroup header="Resources">
                            <NavLink link="/#" label="internship" />
                            <NavLink link="/#" label="Our Products" />
                            <NavLink link="/#" label="User Flow" />
                            <NavLink link="/#" label="User Strategy" />
                        </LinkGroup>
                        <LinkGroup header="Company">
                            <NavLink link="/#" label="About InternX" />
                        ...
                        <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                            <div className="mb-10 w-full">
                                ...
                                <p className="text-base text-body-color dark:text-gray-500">
                                    &copy; 2024  internX
                                </p>
                            </div>
                        </div>
...
const NavLink = ({ link, label }) => {
    return (
        <li>
            <a
                href={link}
                className="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-gray-500"
            >
                {label}
            </a>
        </li>
